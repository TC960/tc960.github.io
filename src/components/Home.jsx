            ...
            {[
              {
                ...
                type: "Part-time",
                description: "Conducting research in design and human-computer interaction, focusing on prototyping methodologies and user experience research within the UC San Diego Design Lab."
              },
              {
                ...
                type: "Part-time",
                description: "Working on a full research pipeline of scraping ~2000 articles, creating an NER and RE script for data extraction and then building a Knowledge Graph to expand research in the field of Microbiology. Spearheading the automation sector by developing an automated Python data collection and analysis pipelines integrated with Google Sheets API to process metadata from 2,000+ research studies with 99%+ accuracy. Built bash-based data automation scripts to streamline sample metadata extraction and generate actionable insights for large-scale microbiome research projects, used by every sub-division in the lab."
              },
              {
